...
@Controller
@RequestMapping("/work/casesTech")
public class CasesTechController {
    @Autowired
    ...
    @Autowired
    ICasesTechBrowseService browseService;
    @Autowired
    ...
    public List<Map<String, Object>> getCasesFreeNums(String CasesID) {
        return browseService.getAllFreeNums(CasesID);
    }
}
