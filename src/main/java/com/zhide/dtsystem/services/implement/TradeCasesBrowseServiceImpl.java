...
import com.zhide.dtsystem.mapper.TradeCasesBrowseMapper;
...
@Service
public class TradeCasesBrowseServiceImpl implements ITradeCasesBrowseService {

    @Autowired
    TradeCasesBrowseMapper tradeCasesBrowseMapper;
    @Autowired
    ...
    public pageObject getData(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = tradeCasesBrowseMapper.getData(params);
        int Total = 0;
