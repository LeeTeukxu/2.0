...
import com.zhide.dtsystem.mapper.FymxWindowMapper;
...
@Service
public class FymxWindowService implements IFymxWindowService {

    @Autowired
    FymxWindowMapper fymxWindowMapper;
    ...
    public pageObject getDataWindow(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = fymxWindowMapper.getDataWindow(params);
        int total = 0;
        if (datas.size() > 0) {
