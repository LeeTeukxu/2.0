...
import com.zhide.dtsystem.mapper.CasesBrowseNewMapper;
...
import com.zhide.dtsystem.services.define.ICasesBrowseNewService;
...
@Service
public class CasesBrowseNewServiceImpl implements ICasesBrowseNewService {

    @Autowired
    CasesBrowseNewMapper browseMapper;
    @Autowired
    ...
    public pageObject getData(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = browseMapper.getData(params);
        int Total = 0;
