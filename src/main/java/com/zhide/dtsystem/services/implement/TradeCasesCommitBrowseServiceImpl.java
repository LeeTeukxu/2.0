...
@Service
public class TradeCasesCommitBrowseServiceImpl implements ITradeCasesCommitBrowseService {
    ...
    public pageObject getData(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = tradeCasesCommitBrowseMapper.getData(params);
        int Total = 0;
