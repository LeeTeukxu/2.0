...
import com.zhide.dtsystem.mapper.ClientWindowMapper;
...
@Service
public class ClientWindowService implements IClientWindowService {

    @Autowired
    ClientWindowMapper clientWindowMapper;
    ...
    public pageObject getDataWindow(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = clientWindowMapper.getDataWindow(params);
        int total = 0;
        if (datas.size() > 0) {
