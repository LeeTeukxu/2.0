...
import com.zhide.dtsystem.mapper.CasesConfirmBrowseMapper;
import com.zhide.dtsystem.models.LoginUserInfo;
import com.zhide.dtsystem.models.sqlParameter;
import com.zhide.dtsystem.multitenancy.CompanyContext;
import com.zhide.dtsystem.services.define.ICasesConfirmBrowseService;
...
@Service
public class CasesConfirmBrowseServiceImpl implements ICasesConfirmBrowseService {

    @Autowired
    CasesConfirmBrowseMapper casesConfirmMapper;

    @Override
    public pageObject getData(HttpServletRequest request) throws Exception {
        pageObject object = new pageObject();
        Map<String, Object> params = getParams(request);
        List<Map<String, Object>> datas = casesConfirmMapper.getData(params);
        int Total = 0;
