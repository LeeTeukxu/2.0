...
import com.zhide.dtsystem.mapper.CasesAllNewBrowseMapper;
...
@Service
public class CasesAllNewServiceImpl implements ICasesAllNewService {
    @Autowired
    CasesAllNewBrowseMapper allMapper;
    @Autowired
    CasesMemoMapper memoMapper;
    @Autowired
    CasesTechBrowseNewMapper techMapper;
    @Autowired
    ...
    @Override
    public CasesBillObject getBillObject(String CasesID) throws Exception {
        CasesBillObject billObject = allMapper.getBillObject(CasesID);
        ...
        List<CasesDetail> Items=techMapper.getDetails(CasesID);
