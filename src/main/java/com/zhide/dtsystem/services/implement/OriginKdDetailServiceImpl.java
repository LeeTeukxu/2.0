...
import com.zhide.dtsystem.mapper.OriginalKdDetailMapper;
...
@Service
public class OriginKdDetailServiceImpl implements IOriginalKdDetailService {

    @Autowired
    OriginalKdDetailMapper detailMapper;
