...
@Service
public class CasesCommitBrowseServiceImpl implements ICasesCommitBrowseService {

    @Autowired
    CasesCommitBrowseMapper casesCommitMapper;
    @Autowired
    ...
    public pageObject getData(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = casesCommitMapper.getData(params);
        int Total = 0;
    ...
    private Map<String, Object> getParams(HttpServletRequest request) throws Exception {
        ...
        if (Strings.isNotEmpty(CasesID)) params.put("CasesID", CasesID);
