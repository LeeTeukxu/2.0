...
import com.zhide.dtsystem.mapper.CasesCompleteBrowseMapper;
...
@Service
public class CasesCompleteServiceImpl implements ICasesCompleteService {
    @Autowired
    CasesCompleteBrowseMapper casesCompleteMapper;
    @Autowired
    ...
    public pageObject getData(HttpServletRequest request) throws Exception {
        ...
        List<Map<String, Object>> datas = casesCompleteMapper.getData(params);
        int Total = 0;
