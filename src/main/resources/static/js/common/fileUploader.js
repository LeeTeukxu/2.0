(function ($) {
    $.fn.fileUploader = function (options) {
        var fileGrid = null, addButton = null, removeButton = null, uploadButton = null, downButton = null, configButton = null,viewButton=null, configCombobox = null, uploader = null;
        var ds = this;
        var buttons = [];
        ...
        function createToolbar() {
            ...
            var op = [
                ...
                '<a class="mini-button" iconcls="icon-user" id="ViewFile" visible="false" style="margin-left:5px"  plain="true">在线查看</a>',
                ...
                init: {
                    ...
                    UploadComplete: function (up, file) {
                        ...
                        if (settings.uploadComplete) {
                            settings.uploadComplete(fileGrid);
                        }
                    },
        ...
        function bindEventByMode(mode) {
            function bindToolbar() {
                                ...
                                if (btn == 'ok') {
                                    $.post(settings.removeUrl, { AttID: attId }, function (r, c) {
                                        ...
                                        if (res['success']) {
                                            ...
                                            if(settings.removeFile)settings.removeFile();
                                            console.log("删除了:"+row["FILENAME"]);
                                        }
                                    });
                                }
                            });
                ...
                viewButton.on('click',viewDocument);
