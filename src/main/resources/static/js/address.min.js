    ...
    ([function (e) {
        ...
        function a(e, n) {
            ...
            if ("undefined" == typeof Symbol || null == e[Symbol.iterator]) {
                if (Array.isArray(e) || (c = r(e)) || n && e && "number" == typeof e.length) {
                    c && (e = c);
                    var d = 0,
                        o = function () {};
                    return {
        ...
        function r(e, n) {
            if (e) {
                ...
                return "Object" === c && e.constructor && (c = e.constructor.name),
                    "Map" === c || "Set" === c ? Array.from(e) : "Arguments" === c || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c) ? i(e, n) : void 0
            }
        }
        function i(e, n) {
            (null == n || n > e.length) && (n = e.length);
            for (var c = 0, d = new Array(n); c < n; c++)
                d[c] = e[c];
            return d
        }
        function l(e) {
        ...
        function t(e) {
            for (var n = 1; n < arguments.length; n++) {
                ...
                n % 2 ? h(Object(c), !0).forEach((function (n) {
                    u(e, n, c[n])
                })) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(c)) : h(Object(c)).forEach((function (n) {
        ...
        function f(e, n) {
            ...
            if (Object.getOwnPropertySymbols) {
                ...
                for (d = 0; d < a.length; d++)
                    c = a[d], n.indexOf(c) >= 0 || Object.prototype.propertyIsEnumerable.call(e, c) && (o[c] = e[c])
            }
            return o
        }
        var p = ["行政区划"];
        o.forEach((function (e) {
            e.children && e.children.forEach((function (n, c) {
                ~p.findIndex((function (e) {
                    return ~n.name.indexOf(e)
                })) && (e.children = e.children.concat(n.children || []), e.children.splice(c, 1))
            }))
        }));
        var s = o.reduce((function (e, n) {
            ...
            v = o.reduce((function (e, n) {
                return e.concat(n.children ? n.children.map((function (e) {
                    e.children;
                    return t(t({}, f(e, ["children"])), {}, {
                        provinceCode: n.code
                    })
                })) : [])
            }), []),
            g = o.reduce((function (e, n) {
                var c = n.code;
        ...
        var x = function (e, n) {
                ...
                if (0 === d.length) {
                    for (var u = 1; u < e.length; u++) {
                        var f = e.substring(0, u + 1),
                            p = new RegExp('{"code":"[0-9]{1,6}","name":"'.concat(f, '[一-龥]*?","provinceCode":"').concat(c[0] ? "".concat(c[0].code) : "[0-9]{1,6}", '"}'), "g"),
                            s = b.match(p);
                        if (!s)
                            break;
                        var v = JSON.parse(s[0]);
                        1 === s.length && (m = f, (d = []).push(v))
                    }
                    if (d[0]) {
                        var g = d[0].provinceCode;
                        if (e = e.replace(new RegExp(m, "g"), ""), 0 === c.length) {
                            var x = new RegExp('{"code":"'.concat(g, '","name":"[一-龥]+?"}'), "g"),
                                S = y.match(x);
                            c.push(JSON.parse(S[0]))
                        }
                    }
                }
                if (0 === o.length) {
                    for (var j = 1; j < e.length; j++) {
                        var w = e.substring(0, j + 1),
                            E = new RegExp('{"code":"[0-9]{1,9}","name":"'.concat(w, '[一-龥]*?","cityCode":"').concat(d[0] ? d[0].code : "[0-9]{1,6}", '","provinceCode":"').concat(c[0] ? "".concat(c[0].code) : "[0-9]{1,6}", '"}'), "g"),
                            k = O.match(E);
                        if (!k)
                            break;
                    ...
                    if (o[0]) {
                        ...
                        if (e = e.replace(m, ""), 0 === c.length) {
                            var J = new RegExp('{"code":"'.concat(A, '","name":"[一-龥]+?"}'), "g"),
                                N = y.match(J);
                            c.push(JSON.parse(N[0]))
                        }
                        if (0 === d.length) {
                            var $ = new RegExp('{"code":"'.concat(R, '","name":"[一-龥]+?","provinceCode":"').concat(A, '"}'), "g"),
                                I = b.match($);
                            d.push(JSON.parse(I[0]))
                        }
                    }
                }
            ...
            S = function (e, n) {
                ...
                if (n.province[0])
                    ...
                    try {
                        for (i.s(); !(r = i.n()).done; ) {
                            for (var l = r.value, h = l.name, t = "", u = h.length; u > 1; u--) {
                                var f = h.substring(0, u);
                                if (0 === e.indexOf(f)) {
                                    t = f;
                                    break
                                }
                        ...
                        var b = function () {
                            ...
                            if (m) {
                                if (m.code === a) {
                                    ...
                                    if (r)
                                        return d.push(n), e = e.replace(new RegExp(r, "g"), ""), "break"
                                }
                            } else {
                                for (var h = o.length; h > 1; h--) {
                                    var t = o.substring(0, h);
                                    if (0 === e.indexOf(t)) {
                                        d.push(n),
                                            c.push(s.find((function (e) {
                                                return e.code === a
                                            }))),
                                            e = e.replace(t, "");
                                        break
                    ...
                    var S = function () {
                        ...
                        if (i || l) {
                            if (i && i.code === m || (l && l.code) === r) {
                                ...
                                if (h)
                                    return o.push(n), !l && d.push(v.find((function (e) {
                                        return e.code === r
                                    }))), !i && c.push(s.find((function (e) {
                                        return e.code === m
                                    }))), e = e.replace(h, ""), "break"
                            }
                        } else {
                            for (var f = a.length; f > 1; f--) {
                                var p = a.substring(0, f);
                                if (0 === e.indexOf(p)) {
                                    o.push(n),
                                        d.push(v.find((function (e) {
                                            return e.code === r
                                        }))),
                                        c.push(s.find((function (e) {
                                            return e.code === m
            ...
            j = function (e, n) {
                ...
                if (["先生", "小姐", "同志", "哥哥", "姐姐", "妹妹", "弟弟", "妈妈", "爸爸", "爷爷", "奶奶", "姑姑", "舅舅"].find((function (n) {
                    ...
                    return e;
                if (~["街道", "乡镇"].findIndex((function (n) {
                    return ~e.indexOf(n)
                })))
                    return "";
                var c = e.substring(0, 1);
                return e.length <= n && e.length > 1 && ~d.indexOf(c) ? e : ""
            },
            w = function (e) {
                var n = "";
            ...
            k = function (e) {
                ...
                e = e.replace(/\r\n/g, " ").replace(/\n/g, " ").replace(/\t/g, " ");
                var c = ["详细地址", "收货地址", "收件地址", "地址", "所在地区", "地区", "姓名", "收货人", "收件人", "联系人", "收", "邮编", "联系电话", "电话", "联系人手机号码", "手机号码", "手机号", "自治区直辖县级行政区划", "省直辖县级行政区划"].concat(n);
        ...
        n.default = function (e, n) {
            var c = "object" === l(n) ? n : "number" == typeof n ? {
                    type: n
                }
                : {},
                d = c.type,
            ...
            p.forEach((function (e, n) {
                if (t.province[0] && t.city[0] && t.area[0])
                    t.detail.push(e);
                else {
                    var c = {};
                    1 === o && (c = S(e, t)),
            ...
            var s = t.province[0],
                ...
                g = t.area[0],
                y = t.detail;
            if (y = y.map((function (e) {
                return e.replace(new RegExp("".concat(s && s.name, "|").concat(v && v.name, "|").concat(g && g.name), "g"), "")
            })), (y = Array.from(new Set(y))) && y.length > 0) {
                var b = m(y).filter((function (e) {
                    return !!e
                }));
                b.sort((function (e, n) {
                ...
                var O = b.findIndex((function (e) {
                    ...
                    P = "";
                ~O ? P = b[O] : b[0].length <= h && /[\u4E00-\u9FA5]/.test(b[0]) && (P = b[0]),
                P && (t.name = P, y.splice(y.findIndex((function (e) {
                    return e === P
                })), 1))
            }
            JSON.stringify(t);
            var C = s && s.name,
                A = v && v.name;
            return ~["市辖区", "区", "县", "镇"].indexOf(A) && (A = C),
                Object.assign(t, {
                    province: C || "",
                    city: A || "",
                    area: g && g.name || "",
                    detail: y && y.length > 0 && y.join("") || ""
                })
        }
    }
    ]).default
