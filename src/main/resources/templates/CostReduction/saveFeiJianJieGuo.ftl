...
<@layout>
    ...
    <div class="baseinfo">
        <div style="width: 100%; overflow: hidden; margin-top: 10px">
            <h1>专利费用减缓办理管理<span style="color: red; font-size: 14px; font-family: 仿宋"></span>
                ...
                <a class="mini-button mini-button-primary" id="CostReductionEdit_Save" onclick="FeiJianJieGuo_Save()">保存</a>
            </span>
            </h1>
        </div>
    </div>
    <div class="container" style="width: 99%; padding-left: 10px">
        <div class="mini-clearfix ">
            ...
            <div class="mini-col-12">
                <div id="Info1" class="mini-panel mini-panel-info" title="费减结果" width="auto" showcollapsebutton="false" showclosebutton="false">
                    <div id="FeiJianJieGuoForm">
                        <table style="width:100%;height: 100%">
                            <tr>
                                <td class="showlabel">费减是否成功:</td>
                                <td style="width:435px;">
                                    <input class="mini-combobox" name="theSuccess" id="theSuccess"  data="fjresult" style="width: 100%" onvaluechanged="isEnableTheYear(this.value)"/>
                                    <input class="mini-hidden" name="costReductionId" id="costReductionId" />
                                </td>
                                <td class="blank"><span style="color: red">&nbsp;</span></td>
                                <td class="showlabel">费减截止年度</td>
                                <td><textarea class="mini-textbox" id="reductionTheYear" name="reductionTheYear" style="width: 100%"></textarea></td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        ...
        var form3 = new mini.Form('FeiJianJieGuoForm');
        ...
        function initDocument(mode) {
            ...
            <#if Mode=="FeiJianJieGuo">
                ...
                form3.setData(loadObj);
                var theYear = mini.get('reductionTheYear');
                if (loadObj.theSuccess.toString() == "2"){
                    theYear.setEnabled(true);
                }else {
        ...
        function FeiJianJieGuo_Save() {
            ...
            if (form3.isValid()) {
                ...
                var url="/CostReduction/saveFeiJianJieGuo";
                $.post(url, arg,
                    function (text) {
                        var res = mini.decode(text);
                        if (res.success) {
                            var data=res.data || {};
                            mini.alert('费减材料审核成功','系统提示',function(){
                                form2.setData(data);
