    ...
    <div class="container" style="width: 99%; padding-left: 10px">
        <div class="mini-clearfix ">
            <div class="mini-col-12">
                <div id="Info1" class="mini-panel mini-panel-info" title="添加快递" width="auto" showcollapsebutton="false" showclosebutton="false">
                    <div id="Table1">
                        <table style="width:100%;height: 100%">
                            <tr>
                                <td class="showlabel">包裹内容: </td>
                                <td>
                                    <input name="packageContent" id="Contents2" class="mini-textbox" value="${contents}" readonly="readonly" style="width: 100%" />
                                </td>
                                ...
                                <td>
                                    <input name="receiver" id="customer" style="width: 100%" textname="LinkMan" class="mini-buttonedit" onbuttonclick="onCustomLinkerDialog()" allowInput="false" required="true" requirederrortext="接收人不能为空"/>
                                </td>
                            </tr>
                            <tr>
                                <td class="showlabel">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input class="mini-hidden" name="id" id="id" value="${id}" />
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            $("#AddExpress").click(function () {
                ...
                if (form.isValid()) {
                    ...
                    var arg={
                        ...
                        dnum:mini.get('id').getValue()
                    };
                    var url="/express/orig/saveExpress";
                    $.post(url, arg,
                        function (text) {
