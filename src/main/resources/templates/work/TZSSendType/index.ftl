    ...
    <div class="mini-layout" style="width:100%;height:100%">
        <div region="center">
            <div class="mini-toolbar">
                <a class="mini-button" id="tbTZSSendType_Save" iconcls="icon-save" onclick="save"
                   plain="true">保存</a>
            </div>
            <div class="mini-fit">
                <div id="treegrid1" class="mini-treegrid" style="width:100%;height:100%;" treeColumn="title"
                     ...
                     ondrawcell="onDrawCell" allowCellWrap="true" autoLoad="true"
                     url="/work/allNotice/getTZSSendTypeData">
...
<@js>
   <script type="text/javascript">
       var tree = null, url = "", currentRole = null;
       $(function () {
               ...
               if (functions.length > 0) {
                   ...
                   for (var i = 0; i < functions.length; i++) {
                       ...
                       var g = '<label style="margin-right:10px;margin-right:10px; vertical-align:bottom;"><input ' +
                               'type="checkbox" name="' + menuId + '_' + funId + '"' + cs + ' hidefocus onclick="checkAction(' + id + ',' + "'" + funId.toString() +"'" + ',this.checked)" />' + funText + '</label>';
                       allText+=funText;
       ...
       function save() {
           ...
           if (count > 0) {
               mini.confirm('确认要保存通知书类型吗?', '系统提示', function (r) {
                   if (r == 'ok') {
                       var url = '/work/allNotice/save';
                       $.ajax({
