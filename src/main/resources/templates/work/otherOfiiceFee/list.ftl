        ...
        <div region="center" style="overflow:hidden">
            <div class="mini-toolbar">
                                ...
                                <div id="info1" style="height:55px;background:rgb(226,250,252);border-radius: 5px;border:1px solid rgb(190,226,240);">
                                    <div class="info1top" style="padding-left: 120px;">
                                        <h3 class="sqf" style="color: rgb(3,154,209);margin-left:-90px;margin-top:17px;font-weight:bold;">
                                            <img style="vertical-align: middle;" src="/appImages/jk.png">&nbsp;其它官费监控
                                        </h3>
                                        <ul>
                                            <li class="Jdlcli AppWatchlySource" id="J1" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('OtherOfficeStates',0,this)">
                                                    <span id="J1span">全部</span>
                                                    <h4 class="x1"></h4>
                                                </a>
                                            </li>
                                            <li class="Jdlcli AppWatchlySource" id="J2" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('OtherOfficeStates',1,this)">
                                                    <span id="J2span">监控中</span>
                                                    <h4 class="x2"></h4>
                                                </a>
                                            </li>
                                            <li class="Jdlcli AppWatchlySource" id="J3" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('OtherOfficeStates',2,this)">
                                                    <span id="J2span">待缴费</span>
                                                    <h4 class="x3"></h4>
                                                </a>
                                            </li>
                                            <li class="Jdlcli AppWatchlySource" id="J3" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('OtherOfficeStates',3,this)">
                                                    <span id="J2span">完成缴费</span>
                                                    <h4 class="x4"></h4>
                                                </a>
                                            </li>
                                            <li class="Jdlcli AppWatchlySource" id="J4" >
                                                <a style="text-decoration:none" target="_self" href="#" onclick="changeQuery('OtherOfficeStates',4,this)">
                ...
                <table style="width:100%">
                    <tr>
                        <td style="width:95%">
                            <a class="mini-button" iconcls="icon-add" id="OtherOfficeFee_Add" onclick="addOtherOfficeFee">增加</a>
                            <a class="mini-button" iconcls="icon-edit" id="OtherOfficeFee_Edit" onclick="editOtherOfficeFee">编辑</a>
                            <a class="mini-button" iconcls="icon-remove" id="OtherOfficeFee_Remove"  onclick="remove">删除</a>
                            <a class="mini-button mini-button-danger" id="OtherOfficeFee_NoPayMark"
                               onclick="changePayStatus('0')">标记不缴费</a>
                            <a class="mini-button mini-button-success" id="OtherOfficeFee_PayMark" onclick="changePayStatus
                            ('1')">标记需缴费</a>
                            <a class="mini-button mini-button-info" id="OtherOfficeFee_AddToFeeList"
                               onclick="addToPayForWait">添加到缴费清单</a>
                            <a class="mini-button mini-button-info" id="OtherOfficeFee_Export" onclick="doExport">导出Excel</a>
                            <a class="mini-button mini-button-info" id="OtherOfficeFee_ExportFee"
                               onclick="doExportYear">导出代缴费清单</a>
                            <a class="mini-button mini-button-primary" id="OtherOfficeFee_Jiaodui" onclick="Jiaodui">校对金额</a>
                            <a class="mini-button mini-button-primary" id="OtherOfficeFee_SXF" onclick="addSXMoney">手续费</a>
                            <span class="separator OtherOfficeFee_Query"></span>
                            <button class="mini-button OtherOfficeFee_Query" iconCls="icon-reload"
                                    onclick="doFixedQuery('JIAOFEIR', 'LT', '${now}')"
                                    plain="true">已过期</button>
                            <button class="mini-button OtherOfficeFee_Query" iconCls="icon-reload"
                                    onclick="doFixedQuery('JIAOFEIR', 'GT', '${next}')" plain="true">未过期</button>
                        </td>
                        <td style="white-space:nowrap;">
                            <div class="mini-combobox Query_Field OtherOfficeFee_Query"  id="comField" style="width:100px"
                                 data="[{id:'All',text:'全部属性'},{id:'ShenQingh',text:'专利号'},{id:'ExpenseItem',text:'缴费清单'},
                                 {id:'FAMINGMC',text:'发明名称'},{id:'SHENQINGRXM',text:'申请人姓名'},{id:'KH',text:'所属客户'},{id:'XS',text:'销售人员'},{id:'DL',text:'代理师'},{id:'LC',text:'流程人员'},{id:'CustomMemo',text:'手动标识'}]" value="All" id="Field"></div>
                            <input class="mini-textbox Query_Field OtherOfficeFee_Query" style="width:150px" id="QueryText" />
                            <a class="mini-button mini-button-success" onclick="doQuery();" id="OtherOfficeFee_Query">模糊搜索</a>
                            <a class="mini-button mini-button-danger" id="OtherOfficeFee_Reset" onclick="reset">重置</a>
                            <a class="mini-button" id="OtherOfficeFee_HighQuery" iconCls="panel-expand" onclick="expand">展开</a>
                        </td>
                    </tr>
                </table>
                <div id="p1" style="border:1px solid #909aa6;border-top:0;height:150px;padding:5px;display:none">
                    <table style="width:100%;" id="highQueryForm">
                        <tr>
                            ...
                            <td style="width:15%;"><input name="JiaoFeiDate" class="mini-datepicker" data-oper="LE"
                                                          style="width:100%"/></td>
                            <td style="width:6%;padding-left:10px;">费用名称</td>
                            <td style="width:15%;"><input name="ExpenseItem" class="mini-textbox" data-oper="LIKE"
                                                          style="width:100%"
                            /></td>
            ...
            <div class="mini-fit" id="fitt">
                <div id="FeeItem_datagrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowclick="onRowClick"
                     frozenstartcolumn="0" frozenendcolumn="8" sortorder="asc" sortfield="JIAOFEIR"
                     ondrawcell="onDraw" allowresize="true" url="/work/otherOfficeFee/getData" multiselect="true"
                     pagesize="20"
                     sizelist="[5,10,20,50,100,200,500,1000,1500,2000]" autoload="true" onload="afterload">
                    <div property="columns">
                        ...
                        <div field="OtherOfficeStates" name="OtherOfficeStates"  width="90" headerAlign="center" type="comboboxcolumn" allowsort="true">监控状态
                            <div property="editor" class="mini-combobox" data="OtherOfficeStates"></div>
                        </div>
                        <div field="Action" width="60" headerAlign="center">备注信息</div>
                        <div field="JIAOFEIR" name="jiaofeir" width="100" allowsort="true"
                             headeralign="center" align="center"  dataType="data" dateFormat="yyyy-MM-dd" >
                            缴费截止日
                        </div>
                        <div field="ExpenseItem" name="expenseItem" width="180" allowsort="true" headeralign="center">
                            费用项目
                        </div>
                        <div field="ExpenseItemID" visible="false"></div>
                        <div field="Type" visible="false"></div>
                        <div field="Amount" name="amount" width="90" allowsort="true" headeralign="center" align="right">
                            金额
                        </div>
                        <div field="XMONEY" name="XMONEY" width="90" allowsort="true" headeralign="center" align="right">
                            人工校对金额
                        </div>
                        ...
                        <div field="SHENQINGLX"  width="120" headerAlign="center" type="treeselectcolumn" allowsort="true">专利类型
...
<script type="text/javascript">
    ...
    var NoPayMark = mini.get('OtherOfficeFee_NoPayMark');
    var ParyMark = mini.get('OtherOfficeFee_PayMark');
    var ToPayForWait = mini.get('OtherOfficeFee_AddToFeeList');
    var Edit = mini.get('OtherOfficeFee_Edit');
    var Remove = mini.get('OtherOfficeFee_Remove');
    $(function(){
        $('#p1').hide();
        fit.setHeight('100%');
        fit.doLayout();

        var con2=$('#J2').children("a");
        if(con2.length>0){
            changeQuery('OtherOfficeStates',1,con2[0]);
        }
    });
    function expand(e) {
        var btn = e.sender;
    ...
    function addToPayForWait(){
        ...
        mini.open({
            url:'/watch/addToPayForWait/otherOfficeIndex?IDS='+ids.join(',')+'&Mode=Add&Type=OtherOfficeFee',
            width:800,
            height:410,
            showModal:true,
            title:'添加到缴费清单',
    ...
    function onDraw(e) {
        ...
        else if (field=="OtherOfficeStates"){
            var dd = record["OtherOfficeStates"];
            if(dd=="1"){
        ...
        mini.prompt("人工校对金额：", "请输入",
                function (action, value) {
                    if (action == "ok") {
                        ...
                        var url = '/work/otherOfficeFee/changeJiaoDuiMoney';
    ...
    function addSXMoney(){
        ...
        function (action, value) {
            if (action == "ok") {
                ...
                var url = '/work/otherOfficeFee/changeShouXiuMoney';
                $.post(url, {IDS:mini.encode(ids),Money:value }, function (r) {
                    if (r['success']) {
    ...
    function changePayStatus(rr){
        ...
        mini.confirm(msg,'设置提示',function(action){
            if(action=='ok'){
                var url = '/work/otherOfficeFee/changePayStatus';
    ...
    function ShowMemo(id, title) {
        ...
        mini.open({
            url: '/watch/feeWatch/addMemo?Type=OtherOfficeFee&ID=' + id,
            showModal: true,
            width: 1000,
            height: 600,
            title: "【" + title + "】的备注信息",
    ...
    function addOtherOfficeFee(){
        mini.open({
            url:'/work/otherOfficeFee/add',
            width:'100%',
            height:'100%',
            title:'新增其它官费设置及监控',
            showModal:true,
    ...
    function changeQuery(code, state,obj) {
        ...
        var id=con.prop('id') || "";
        if(id.toString().indexOf('span')==-1)con=$(obj).children("span");
        var cons=$('.Jdlcli');
    ...
    function editOtherOfficeFee(){
        var row=grid.getSelecteds();
        if(!row) {
            mini.alert('请选择要编辑的其它官费信息!');
            return ;
        }
        var strSHENQINGH=[];
        var strExpenseItemID=[];
        var strType=[];
        var strID=[];
        for (var i=0;i<row.length;i++){
            strSHENQINGH.push(row[i].SHENQINGH);
            strExpenseItemID.push(row[i].ExpenseItemID);
            strType.push(row[i].Type);
            strID.push(row[i].id);
        }
        mini.open({
            url:'/work/otherOfficeFee/edit?SHENQINGH='+strSHENQINGH+'&ExpenseItem='+strExpenseItemID+'&Type='+strType+'&ID='+strID,
            width:'100%',
            height:'100%',
            title:'修改其它官费设置及监控',
            showModal:true,
    ...
    function remove() {
        ...
        mini.confirm('确认要删除的其它官费监控数据?', '删除提示', function (act) {
            if (act === 'ok') {
                var url="/work/otherOfficeFee/remove";
                $.ajax({
    ...
    function updateNumber() {
        var url="/work/otherOfficeFee/refreshTotal";
    ...
    function onRowClick() {
        ...
        for (var i=0;i<rows.length;i++){
            var row=rows[i];
            var OtherOfficeStates=parseInt(row["OtherOfficeStates"]);

            offs.push(OtherOfficeStates);
        }
        if (offs.indexOf(2)>-1 || offs.indexOf(3)>-1){
            NoPayMark.disable();
            ParyMark.disable();
