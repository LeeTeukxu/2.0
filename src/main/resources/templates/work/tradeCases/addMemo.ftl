...
<div class="mini-fit">
    <div class="mini-datagrid" id="grid1" style="width:100%;height:100%" allowcellselect="true" allowcelledit="true"
         url="/work/tradeCases/getMemoData?CasesID=${CasesID}" oncellbeginedit="beforeEdit" allowCellWrap="true"
...
<@js>
    <script type="text/javascript">
        ...
        function onSave() {
            ...
            var url = '/work/tradeCases/saveMemo';
        ...
        function onRemove() {
            ...
            if (row) {
                var fu = function () {
                    var id = row["ID"];
                    var url = '/work/tradeCases/removeMemo';
