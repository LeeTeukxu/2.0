        ...
        <div region="center" style="overflow:hidden">
            <div class="mini-toolbar">
                <table style="width:100%">
                    <tr>
                        <td style="width:95%">
                            <a class="mini-button mini-button-info" id="GovWait_Export"
                               onclick="doExport">导出Excel</a>
                        </td>
                        <td style="white-space:nowrap;">
                            <div class="mini-combobox Query_Field GovWait_Query" id="comField" style="width:100px"
                                 ...
                                 id="Field"></div>
                            <input class="mini-textbox Query_Field GovWait_Query" style="width:150px"
                                   id="QueryText"/>
                            <a class="mini-button mini-button-success" onclick="doQuery();" id="GovWait_Query">模糊搜索</a>
                            <a class="mini-button mini-button-danger" id="GovWait_Reset" onclick="reset">重置</a>
                            <a class="mini-button" id="GovWait_HighQuery" iconCls="icon-expand"
            ...
            <div class="mini-fit" id="fitt">
                <div id="GovWait_datagrid" class="mini-datagrid" style="width: 100%; height: 100%;" onrowclick="onRowClick"
                     frozenstartcolumn="0" frozenendcolumn="6" sortorder="asc" sortfield="shenqingh"
                     ondrawcell="onDraw" allowresize="true" url="/work/govFee/getData?PayState=0" multiselect="true"
                     pagesize="20"
...
<script type="text/javascript">
    ...
    var grid = mini.get('GovWait_datagrid');
    var txtQuery = mini.get('#QueryText');
    var comField = mini.get('#comField');
    var cmdQuery=mini.get('#GovWait_Query');
    $(function () {
        $('#p1').hide();
        fit.setHeight('100%');
        fit.doLayout();
