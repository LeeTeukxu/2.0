                ...
                <table style="width:100%;" cellpadding="0" cellspacing="0">
                    <tr>
                        <td style="width:100%;" id="toolbarContainer">
                            <a class="mini-button" iconcls="icon-upload" id="CasesBrowse_Audit"
                            ...
                            <a class="mini-button" iconcls="icon-zoomin" id="CasesBrowse_NBBH"
        ...
        if (row) {
            ...
            mini.showMessageBox({
                ...
                callback: function (action) {
                    if (action == 'yes') {
                        var url = '/work/casesConfirm/commit';
