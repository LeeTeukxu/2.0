        ...
        <div region="center" bodyStyle="overflow:hidden">
                    ...
                    <tr>
                        <td style="width:100%;">
                            <a class="mini-button" iconcls="icon-ok" id="CasesBrowse_Audit"
                               onclick="auditCases" visible="false">业务完结</a>
                            <a class="mini-button" iconcls="icon-cancel" id="CasesBrowse_UnAudit"
                               onclick="unAuditCases" visible="false">取消完结</a>
            ...
            <div class="mini-fit" id="fitt" style="width:100%;height:100%;overflow:hidden">
                <div class="mini-datagrid" id="datagrid1" style="width:100%;height:100%" onDrawCell="onDraw"
                     ...
                     sortorder="desc" pagesize="20" onload="afterload" url="/work/casesComplete/getData?State=${State}"
                    ...
                    <div property="columns">
                        ...
                        <div field="FeiJian"  align="center" width="100" headeralign="center"  allowsort="true">费减情况
                        </div>
...
<@js>
    <script type="text/javascript">
        ...
        var cmdUnAudit=mini.get('#CasesBrowse_UnAudit');
        ...
        function auditCases(){
            ...
            if(row){
                ...
                mini.confirm('确认要将选择的业务交单提交到完结？','系统提示',function(result){
                    if(result=='ok'){
                        var url='/work/casesComplete/commit';
